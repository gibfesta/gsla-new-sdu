    ...
    () => ({
      ...
      courses: [
        ...
        },
        {
          ...
          status: "Booked" as const, // showing “needs renewal booked”
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-1 text-sm text-slate-600">
                      Preferred name: <span className="font-semibold text-slate-800">{profile.preferredName}</span>
                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      <div className="min-w-0">
                        ...
                        <div className="mt-1 text-xs text-slate-600">
                          Registration: <span className="font-mono font-semibold text-slate-800">{m.registrationNo}</span>
                          <span className="mx-2 text-slate-300">•</span>
                    ...
                    >
                      ...
                      <div className="shrink-0">
                        <Badge tone={statusTone as any}>
                          {a.status === "Upcoming" ? <Clock size={14} /> : a.status === "Completed" ? <CheckCircle2 size={14} /> : <XCircle size={14} />}
                          {a.status}
                        </Badge>
                      </div>
                    </div>
                  ...
                  <div key={d.name} className="rounded-2xl border border-slate-200 bg-white p-4">
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <div className="mt-1 text-xs text-slate-600">
                          Expiry:{" "}
                          <span className="font-semibold text-slate-700">{d.expiry ?? "—"}</span>
                        </div>
                      </div>
