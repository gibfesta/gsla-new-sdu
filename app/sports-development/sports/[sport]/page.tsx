// app/sports-development/sports/[sport]/page.tsx
"use client";
      ...
      <div className="mx-auto max-w-7xl space-y-6 px-6 py-6">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              >
                ...
                <div className="mt-4">
                  <Link
                    href={`/sports-development/sports/${sport}/governance`}
        ...
        {tab === "teams" ? (
          <SectionShell
            ...
            right={
              <div className="flex flex-wrap items-center gap-2">
                <Link
                  href={`/sports-development/sports/${sport}/teams`}
                  className="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-800 hover:bg-slate-50"
                >
        ...
        {tab === "participants" ? (
          <SectionShell
            ...
            right={
              <Link
                href={`/sports-development/sports/${sport}/participants`}
        ...
        {tab === "coaches" ? (
          <SectionShell
            ...
            right={
              <div className="flex flex-wrap items-center gap-2">
                <Link
                  href={`/sports-development/sports/${sport}/coaches`}
                  className="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-3 py-2 text-sm font-semibold text-slate-800 hover:bg-slate-50"
                >
