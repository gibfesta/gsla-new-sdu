// app/sports-development/sports/[sport]/coaches/page.tsx
...
import { useParams } from "next/navigation"; // Reads the dynamic route param: /sports-development/sports/[sport]/coaches.
import {
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          ...
          <div>
            ...
            <Link
              href={`/sports-development/sports/${sport}`}
