...
// app/sports-development/teams/add/page.tsx
...
|   2) Return teamId
|   3) Redirect to /sports-development/teams or /sports-development/teams/[id]
|--------------------------------------------------------------------------
*/
          ...
          {saved ? (
            <div className="rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-900">
              ...
              <div className="mt-1 text-xs text-emerald-900/80">
                Next: wire backend + redirect to /sports-development/teams (list) or /sports-development/teams/[id].
              </div>
            </div>
          ) : null}
        </div>
