// app/sports-development/associations/registration/page.tsx
"use client";
 ...
 * - Current route requested by you: /sports-development/associations/registration
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-slate-600">
            Association annual registration (UI-only draft). Route: /sports-development/associations/registration
          </p>
        </div>
