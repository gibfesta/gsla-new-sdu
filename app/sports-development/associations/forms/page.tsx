...
const forms: Form[] = [
  {
    ...
    type: "annual",
    baseRoute: "/sports-development/associations/registration",
    years: [
  ...
  },
  {
    ...
    type: "annual",
    baseRoute: "/sports-development/associations/form-b",
    years: [
  ...
  type: "annual",
  baseRoute: "/sports-development/associations/form-c",
  years: [
    { year: currentYear, status: "Not Started" },
    { year: currentYear - 1, status: "Completed" },
    { year: currentYear - 2, status: "Incomplete" },
