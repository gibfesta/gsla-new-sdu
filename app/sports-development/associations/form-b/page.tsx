// app/sports-development/associations/form-b/page.tsx
"use client";
 ...
 * - Route: /sports-development/associations/form-b
 *
    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-slate-600">Application for financial assistance (UI-only draft). Route: /sports-development/associations/form-b</p>
        </div>
