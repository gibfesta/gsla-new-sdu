...
// app/sports-development/leagues/[leagueId]/page.tsx
...
|--------------------------------------------------------------------------
| Route:
| - /sports-development/leagues/[leagueId]
|
| Purpose:
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            <Link
              href="/sports-development/leagues"
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Link href={`/sports-development/leagues/${leagueId}/teams/add`}>
            <Button>
