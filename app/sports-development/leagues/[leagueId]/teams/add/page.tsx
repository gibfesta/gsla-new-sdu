...
// app/sports-development/leagues/[leagueId]/teams/add/page.tsx
...
|--------------------------------------------------------------------------
| Route:
| - /sports-development/leagues/[leagueId]/teams/add
|
| Purpose:
...
export default function Page() {
  ...
  function saveUiOnly() {
    ...
    // router.push(`/sports-development/leagues/${leagueId}`);
  }
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            <Link
              href={`/sports-development/leagues/${leagueId}`}
          ...
          {saved ? (
            <div className="rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-900">
              ...
              <div className="mt-1 text-xs text-emerald-900/80">
                Next: POST to backend + redirect back to /sports-development/leagues/{leagueId}.
              </div>
              <div className="mt-3">
                <Button onClick={() => router.push(`/sports-development/leagues/${leagueId}`)}>
                  Back to league
                </Button>
              </div>
            </div>
