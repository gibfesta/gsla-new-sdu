    ...
    */
    ...
    const addHref =
      x === "Users"
        ...
        ? "/sports-development/leagues/add"
        : undefined;
    ...
    const editHref =
      x === "Users"
        ...
        : x === "Create a League or Competition"
        ? "/sports-development/leagues"
        : x === "Form A"
        ? "/sports-development/associations/registration"
        : x === "Form B"
        ? "/sports-development/associations/form-b"
        : x === "Form C"
        ? "/sports-development/associations/form-c"
        : undefined;
        ...
        <CardContent>
          ...
          <div className="mt-4 flex gap-2">
            {addHref ? (
              ...
              <button disabled className="rounded-xl bg-slate-200 px-3 py-2 text-sm font-semibold text-slate-500">
                Add
              </button>
            )}
            ...
            {editHref ? (
              ...
              <button disabled className="rounded-xl border border-slate-200 px-3 py-2 text-sm text-slate-400">
                Edit
              </button>
            )}
          </div>
