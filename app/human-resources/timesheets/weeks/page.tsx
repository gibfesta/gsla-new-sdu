...
export default async function TimesheetWeeksPage() {
  ...
  async function createWeekPack() {
    ...
    revalidatePath("/human-resources/timesheets/weeks");
  }
  ...
  <a href="/human-resources/timesheets/weeks/demo-week" className="mt-3 inline-block rounded-xl bg-[#0C2F57] px-4 py-2 text-sm font-semibold text-white">Open demo week</a>
</div>
                ...
                {weeks.map((w) => {
                  ...
                  return (
                    <tr key={w.id} className="border-t border-slate-100">
                      ...
                      <td className="px-5 py-4">
                        <Link
                          href={`/human-resources/timesheets/weeks/${w.id}`}
